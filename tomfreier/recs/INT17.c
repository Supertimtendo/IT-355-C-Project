...
// Assigning an unsigned type to -1 will cause it to wrap around to the maximum value. 
// Thus giving the max value regardless of the given compiler implementation.
